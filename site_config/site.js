// 全局的一些配置
export default {
  rootPath: '/docs', // 发布到服务器的根目录，需以/开头但不能有尾/，如果只有/，请填写空字符串
  port: 8080, // 本地开发服务器的启动端口
  domain: 'athlonreg.github.io', // 站点部署域名，无需协议和path等
  ...
  'en-us': {
    ...
    copyright: 'Copyright © 2018 https://blog.iamzhl.top/',
  },
  'zh-cn': {
    pageMenu: [
      {
